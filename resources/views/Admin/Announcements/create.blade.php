...
<div class="mws-panel grid_8"> 
   	<div class="mws-panel-header"> 
    	<span>
    		<font style="vertical-align: inherit;">
    			<font style="vertical-align: inherit;">公告添加</font>
    		</font>
    	</span> 
   	</div> 
	   <div class="mws-panel-body no-padding"> 
			...
			<form class="mws-form" action="/admin/announcements" method="post" enctype="multipart/form-data">
			     	{{ csrf_field() }} 
			    <div class="mws-form-inline"> 
			      	...
			      	<div class="mws-form-row"> 
			       		...
			       		<div class="mws-form-item"> 
			       	 		<input type="text" name="author" class="small" value="{{ session('nickname') }}" /> 
			       		</div> 
			      	</div> 
			      	<div class="mws-form-row"> 
			       		...
			       		<div class="mws-form-item" style="width: 60%;height: auto;"> 
			        		<!-- 加载编辑器的容器 -->
						    <script id="container" name="content" value="{{ old('content') }}" type="text/plain">
